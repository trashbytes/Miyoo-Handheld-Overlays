...
With that in mind there is at least one system where it does make sense. The Sega Master System is letterboxed by design and thus needs either black bars or a bezel on a 4:3 screen. Luckily it also has a fixed resolution.
